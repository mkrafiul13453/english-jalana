...
const displayLevelWord = (words) =>{
    ...
    if(words.length == 0){
        ...
        <img class="mx-auto" src="./assets/alert-error.png" alt="">
            <p class="text-xl font-medium text-gray-600">এই Lesson এখনো কোন Vocabulary যুক্ত করা হয়নি।</p>
    ...
    words.forEach(word => {
        ...
        <div class="bg-white rounded-xl shadow-sm text-center py-10 px-5 space-y-4">
            ...
            <div class="flex justify-between items-center">
                <button onclick="loadWordDetail(${word.id})" class="btn bg-gray-100 hover:bg-gray-300"><i class="fa-solid fa-circle-info "></i></button>
                <button onclick="pronounceWord('${word.word}')" class="btn bg-gray-100 hover:bg-gray-300"><i class="fa-solid fa-volume-high "></i></button>
            </div>
        </div>
        `;
